...
* [**Multi-Cloud Resource Dataset (Kaggle)**](https://www.kaggle.com/datasets/freshersstaff/multi-cloud-resource-dataset)**:** Contains time-series records of multi-cloud workload activity, including usage metrics, configuration, cost, and scaling actions.
